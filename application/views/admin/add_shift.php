    ...
    <div class="card rounded-0">
      ...
      <?= $this->session->flashdata('message'); ?>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-4">
            <input type="text" readonly class="form-control form-control-lg" value="<?php echo $s_id;?>">
          </div>
        </div>
          ...
          <div class="row">
            <div class="col-sm-4">
              <input type="number" class="form-control form-control-lg" name="s_start_h" id="s_start_h" max="23" min="0" placeholder="Hour" value="<?php echo set_value('s_start_h')?>">
              <?php echo form_error('s_start_h', '<small class="text-danger">', '</small>');?>
                                    </div>
            <div class="col-sm-4">
              <input type="number" class="form-control form-control-lg" name="s_start_m" id="s_start_m" max="59" min="0" placeholder="Minutes" value="<?php echo set_value('s_start_m')?>">
              <?php echo form_error('s_start_m', '<small class="text-danger">', '</small>');?>
                                    </div>
            <div class="col-sm-4">
              <input type="number" class="form-control form-control-lg" name="s_start_s" id="s_start_s" max="59" min="0" placeholder="Seconds" value="<?php echo set_value('s_start_s')?>">
        ...
        <div class="form-group">
          ...
          <div class="row">
            <div class="col-sm-4">
              <input type="number" class="form-control form-control-lg" name="s_end_h" id="s_end_h" max="23" min="0" placeholder="Hour" value="<?php echo set_value('s_end_h')?>">
              <?php echo form_error('s_end_h', '<small class="text-danger">', '</small>');?>
                                    </div>
            <div class="col-sm-4">
              <input type="number" class="form-control form-control-lg" name="s_end_m" id="s_end_m" max="59" min="0" placeholder="Minutes" value="<?php echo set_value('s_end_m')?>">
              <?php echo form_error('s_end_m', '<small class="text-danger">', '</small>');?>
                                    </div>
            <div class="col-sm-4">
              <input type="number" class="form-control form-control-lg" name="s_end_s" id="s_end_s" max="59" min="0" placeholder="Seconds" value="<?php echo set_value('s_end_s')?>">
